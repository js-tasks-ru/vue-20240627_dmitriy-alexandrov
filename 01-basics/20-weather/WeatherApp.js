...
export default defineComponent({
  ...
  setup() {
    ...
    function getWeatherIcon(id) {
      return WeatherConditionIcons[id] || null;
    }
  ...
  template: `
    <div>
      ...
      <ul class="weather-list unstyled-list">
        <li v-for="weather in weatherData" :class="['weather-card', isDayTime(weather.current.dt, weather.current.sunrise, weather.current.sunset) ? '' : 'weather-card--night']">
